package test.com.techtorial.project;

import main.com.techtorial.project.BestProject;
...
public class BestProjectTest {

    @Test
    public void countLettersTest() {
        Assert.assertEquals(map, BestProject.countLetters(word));
    }

    @Test
    public void countLettersTest1() {
        Assert.assertEquals(map1, BestProject.countLetters(word1));
    }

    @Test
    public void countLettersTest2() {
        Assert.assertEquals(map2, BestProject.countLetters(word2));
    }

    @Test
    public void countLettersTest3() {
        Assert.assertEquals(map3, BestProject.countLetters(word5));
    }

    @Test
    public void uniqeLettersTest() {
        Assert.assertEquals(unique5, BestProject.uniqueLetters(word5));
    }

    @Test
    public void uniqeLettersTest2() {
        Assert.assertEquals(unique2, BestProject.uniqueLetters(word2));
    }

    @Test
    public void uniqeLettersTest3() {
        Assert.assertEquals(unique3, BestProject.uniqueLetters(word3));
    }

    @Test
    public void complicatedDataTypesTest() {
        Assert.assertEquals(listOfMaps, BestProject.complicatedDtaTypes(word6));
    }

    @Test
    public void complicatedDataTypesTest1() {
        Assert.assertEquals(listOfMaps1, BestProject.complicatedDtaTypes(word3));
    }

    @Test
    public void complicatedDataTypesTest2() {
        Assert.assertEquals(listOfMaps3, BestProject.complicatedDtaTypes(word5));
    }
